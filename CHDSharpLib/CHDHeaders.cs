...
public class CHDHeaders
{
    public chd_error ReadHeaderV1(Stream file, out CHDHeader chd)
    {
        unchecked
        {
            chd = new CHDHeader();
    ...
    public chd_error ReadHeaderV2(Stream file, out CHDHeader chd)
    {
        unchecked
        {
            chd = new CHDHeader();
    ...
    public chd_error ReadHeaderV3(Stream file, out CHDHeader chd)
    {
        unchecked
        {
            chd = new CHDHeader();
    ...
    public chd_error ReadHeaderV4(Stream file, out CHDHeader chd)
    {
        unchecked
        {
            chd = new CHDHeader();
    ...
    public chd_error ReadHeaderV5(Stream file, out CHDHeader chd)
    {
        unchecked
        {
            chd = new CHDHeader();
    ...
    private chd_error uncompressed_v5_map(BinaryReader br, ulong mapoffset, uint totalblocks, out mapentry[] map)
    {
        unchecked
        {
    ...
    private chd_error compressed_v5_map(BinaryReader br, ulong mapoffset, uint totalBlocks, uint blocksize, uint unitbytes, out mapentry[] map)
    {
        unchecked
        {
            map = new mapentry[totalBlocks];
